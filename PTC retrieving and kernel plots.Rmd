...
```{r}
#1. Potential PTCome
potential_PTCome <- str_sub(PTEN_potential$`Gene name:  PTEN`, 4, 9)   #INSERT HERE THE NAME OF YOUR POTENTIAL PTCOME TEXT FILE
...
protein_length <- 403   #INSERT HERE YOUR PROTEIN LENGHT
...
#plot
plot(d_100_potential, main= protein_name, col="black", ylim=c(0,0.005), lwd=3.5, xlim=c(0,100))
